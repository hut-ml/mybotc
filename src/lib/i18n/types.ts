...
export type Translations = {
  ...
  newGame: {
    ...
    playerCountHelp: string
    recommendedSplit: string
    seatsAutoGenerated: string
    roleDrawTitle: string
    roleDrawSubtitle: string
    roleDrawHelp: string
    rolesDealtLabel: string
    regenerateDeck: string
    tapToRevealRole: string
    drunkSetupTitle: string
    drunkSetupSubtitle: string
    drunkSetupDescription: string
    chooseBelievedRole: string
    playerNameLabel: string
    playerNamePlaceholder: string
    lockRoleAndName: string
    ...
    demonNotAssignedWarning: string
  ...
  game: {
    ...
    alivePlayersLabel: string
    blockThresholdLabel: string
    ...
    // History
    gameHistory: string
    storytellerMenu: string
    showGrimoire: string
    showAllCharacters: string
    takeNotes: string
    ...
    showActionAgain: string
    actionReplayDescription: string
    rerunSkippedAction: string
    rerunSkippedActionWarning: string
    minionInfo: string
    minionInfoDescription: string
    minionInfoSkippedUnderSeven: string
    demonInfo: string
    ...
    grimoireReviewSubtitle: string
    grimoireReviewHint: string
    grimoireCircle: string
    grimoireViewCircle: string
    grimoireViewList: string
    grimoireSelectedSeat: string
    grimoireSeat: string
    grimoireLeftNeighbor: string
    grimoireRightNeighbor: string
    grimoireReseatMode: string
    grimoireReseatHint: string
    grimoireReseatDone: string
    grimoireSwapPrompt: string
    continueToNightPrep: string
    continueToNightActions: string
    nightPrepSummary: string
    nightPrepPending: string
    nightPrepRedHerring: string
    nightPrepNoTarget: string
    nightPrepEvilPairs: string
  ...
  history: {
    ...
    roleChanged: string
    setupAction: string
    reviewedGrimoire: string
    reseatedPlayers: string
  }
  ...
  scripts: {
    ...
    betaTag: string
    importScript: string
    importScriptSubtitle: string
    importScriptHelp: string
    importPasteJson: string
    importFromUrl: string
    importPasteJsonHelp: string
    importFromUrlHelp: string
    importJsonPlaceholder: string
    importValidate: string
    importValidating: string
    importNotSupported: string
    importUnsupportedHelp: string
    importParseError: string
    continueToWakeOrder: string
    wakeOrderImportTitle: string
    wakeOrderCustomTitle: string
    wakeOrderSubtitle: string
    firstNightWakeOrder: string
    otherNightWakeOrder: string
    wakeOrderHint: string
    resetWakeOrder: string
    noWakeRoles: string
    reactiveWakeRoles: string
    reactiveWakeRolesHint: string
    conditionalWakeTag: string
    saveScript: string
    editWakeOrder: string
    scriptNameLabel: string
    scriptAuthorLabel: string
    scriptAuthorPlaceholder: string
    byAuthor: string
    selectScript: string
